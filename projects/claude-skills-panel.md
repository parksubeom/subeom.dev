...
description: "Claude Code 슬래시 커맨드를 한 번의 클릭으로 실행하는 VS Code 확장. Open VSX 6,082 다운로드 · 평점 5.0, 7일 만에 v0.44.6, 4개 IDE · 4개 언어 배포."
...
detailInfo:
  ...
  sections:
    ...
    - title: "성과"
      content: |
        - **Open VSX 6,082 다운로드 · 평점 5/5.0** (VS Code Marketplace 합산 누적 6100+)
