...
description: "Claude Code 슬래시 커맨드를 한 번의 클릭으로 실행하는 VS Code 확장. 누적 9,994 다운로드 (Open VSX + VS Code Marketplace) · 평점 5.0, 7일 만에 v0.44.6, 4개 IDE · 4개 언어 배포."
...
detailInfo:
  ...
  sections:
    ...
    - title: "성과"
      content: |
        - **누적 9,994 다운로드 · 평점 5/5.0** (Open VSX 8,610 + VS Code Marketplace 1,384)
