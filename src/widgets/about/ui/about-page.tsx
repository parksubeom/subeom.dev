...
const experiences = [
  {
    ...
    achievements: [
      "학생 답안 히스토리 저장 용량 최대 405배 절감(3.7MB → 9.3KB) — 저장 경계에 델타·컨테이너·gzip·소비-기반 strip 순수함수 변환기 적용, 재생 엔진 무수정·재생 품질 손실 0 (복원 동일성 27케이스·전체 1,101 테스트 통과). 합성 벤치 17×가 실제 1.1×로 무너진 뒤 실측 진단으로 진짜 병목(불필요 3D 직렬화)을 특정",
